...
\personal{This lemma might be as well erase, as it is a direct consequence of the previous proposition. We will need nonetheless this result in the construction
of $\rB_X(Y)$.}
...
\begin{proof}
    ...
    case the statement follows immediately by the universal property of the cotangent complex. \todo{Add details in this proof.}
\end{proof}
...
We now use the \emph{pseudo-nil-descent} for $\pro(\Coh^+(X))$ \todo{define what this means}, to compute relative cotangent complexes of
